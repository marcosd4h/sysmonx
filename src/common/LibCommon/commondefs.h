...
{
	constexpr uint32_t MAX_BUFFER_SIZE = 2048;
	...
	constexpr DWORD SYSTEM_MIN_VALID_PID = 5; // System processes are found below this
	constexpr size_t DEFAULT_PAGE_SIZE = 4096;
	constexpr UINT32 RANDOM_STRING_LENGTH = 12;
	...
	constexpr BYTE VERISIGN_CERT_THUMBPRINT[] = { 0x4E, 0xB6, 0xD5, 0x78, 0x49, 0x9B, 0x1C, 0xCF, 0x5F, 0x58, 0x1E, 0xAD, 0x56, 0xBE, 0x3D, 0x9B, 0x67, 0x44, 0xA5, 0xE5 };
	constexpr BYTE ADDTRUST_CERT_THUMBPRINT[] = { 0x02, 0xFA, 0xF3, 0xE2, 0x91, 0x43, 0x54, 0x68, 0x60, 0x78, 0x57, 0x69, 0x4D, 0xF5, 0xE4, 0x5B, 0x68, 0x85, 0x18, 0x68 };
}